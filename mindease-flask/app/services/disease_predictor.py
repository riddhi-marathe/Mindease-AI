...
class DiseasePredictors:
    ...
    @staticmethod
    def predict_disease(
        symptoms: list, age: int = None, medical_history: list = None
    ) -> dict:
        """
        ...
        for symptom in symptoms:
            ...
            if symptom_key in DiseasePredictors.SYMPTOM_CONDITIONS:
                for condition, score in DiseasePredictors.SYMPTOM_CONDITIONS[
                    symptom_key
                ].items():
        ...
        urgency = DiseasePredictors._determine_urgency(
            symptoms, sorted_conditions, age, medical_history
        )
        ...
        return {
            ...
            "recommendation": DiseasePredictors._get_recommendation(
                urgency, sorted_conditions
            ),
    ...
    def _determine_urgency(
        symptoms: list, conditions: list, age: int = None, medical_history: list = None
    ) -> str:
        """
